...
module.exports = function (req, res, url) {
	...
	switch (url.pathname) {
		case "/cc": {
			title = 'Wrapper Galaxy - Character Creator';
			attrs = {
		...
		case "/cc_browser": {
			title = "Wrapper Galaxy - Character Browser";
			attrs = {
		...
		case "/go_full/tutorial": {
			...
			title = "Wrapper Galaxy - Video Editor";
			attrs = {
		...
		case "/player": {
			title = "Wrapper Galaxy - Video Player";
			attrs = {
		...
		case "/recordWindow": {
			title = "Wrapper Galaxy - Record Window";
			attrs = {
				data: process.env.SWF_URL + "/player.swf",
				type: "application/x-shockwave-flash",
				id: "video_player",
	...
	<head>
		...
		<script src="/pages/js/swfpage.js"></script>
		<script>
